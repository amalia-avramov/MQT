...
public class JsonProducer {
    ...
    public static void main(String[] args){
        ...
        String json="{\n" +
                "    \"nume\":\"Avramov\",\n" +
                "    \"prenume\":\"Amalia\",\n" +
                "    \"functie\":\"student master\"\n" +
                "}";
        // create message for topic events2, no key
        ProducerRecord<String, String> data2 = new ProducerRecord<>("events2", json);
        ...
        try {
            RecordMetadata meta = producer.send(data2).get();
            LOG.info("aaaaaaaaaaaaaaaaaaaaaaaa key = {}, value = {} ==> partition = {}, offset = {}", data2.key(), data2.value(), meta.partition(), meta.offset());

            RecordMetadata meta1 = producer.send(data2).get();
            LOG.info("bbbbbbbbbbbbbbbbbbbbbbbbb key = {}, value = {} ==> partition = {}, offset = {}", data2.key(), data2.value(), meta1.partition(), meta1.offset());
